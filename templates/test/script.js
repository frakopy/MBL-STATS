...
// //This td was removed because the client prefer all stats displayed in the same page 
// //<td><a id="view-stats" href="#stats-results">View Stats</a></td>

// //----------- Sending Post to the backend with the date data for get the games scheduled -----------------------------

// const get_games = async (dateToSend) => {
...
//     try{
//         const request = await fetch('/get_games', fetchSettings)
//         const result = await request.json()
//         return result
//     }catch(error){
//         return error
...
// get_games(dateToSend).then(result => {showGames(result)})
